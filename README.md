...
* **Result Data:** Access the final tabulated gene metrics in [DESeq2 Differential Expression Results Plot](results/deseq2_differential_expression_results_plot.png).
